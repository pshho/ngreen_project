				...
				<fieldset>
					<ul>
						...
						<li><label for="gender">성별</label> <label class="la1"><input
								type="radio" name="gender" id="gender" value="남" checked>남</label> <label
							class="la1"><input type="radio" name="gender" id="gender"
								value="여">여</label></li>
					</ul>
				</fieldset>
				<div class="button">
					<input type="button" value="등록" onclick="checkMember()"> <input type="reset"
						value="취소">
				</div>
			</form>
		</section>
