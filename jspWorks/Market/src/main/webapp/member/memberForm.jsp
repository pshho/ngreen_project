...
<body>
	...
	<div class="container my-3">
		...
		<div class="row">
			<form action="/addMember.do" method="post" name="member" onsubmit="return checkMember();">
				<div class="form-group row">
					...
					<div class="col-sm-3 my-2">
						<button type="button" id="btnChk" value="N" name="btnChk"
				...
				<div class="form-group row">
					...
					<div class="col-sm-3 my-2">
						<input type="password" name="passwd1" id="passwd1" class="form-control" required>
					</div>
				</div>
				<div class="form-group row">
